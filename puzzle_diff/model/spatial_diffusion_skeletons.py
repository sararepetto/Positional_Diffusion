...
from .backbones.efficient_gat_skeletons import Eff_GAT_Skeletons
...
class GNN_Diffusion(pl.LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.model = Eff_GAT_Skeletons(steps=steps, input_channels=1, output_channels=1)
    ...
    def skeleton_features(self, skeletons):
        return self.model.skeleton_features(skeletons)
    ...
    def p_losses(
        ...
        skeletons_feats = self.skeleton_features(skeletons)
    ...
    def p_sample_loop(self, shape, cond, edge_index, batch):
        ...
        skeleton_feats = self.skeleton_features(cond)
